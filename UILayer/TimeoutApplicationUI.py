...
import TimeoutApplicationUISupport
import os
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    TimeoutApplicationUISupport.set_Tk_var()
    top = Toplevel1 (root)
    TimeoutApplicationUISupport.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    TimeoutApplicationUISupport.set_Tk_var()
    top = Toplevel1 (w)
    TimeoutApplicationUISupport.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.configure(text='Welcome ' + TimeoutApplicationUISupport.userName)
        ...
        for item in TimeoutApplicationUISupport.userHistoryData:
        ...
        for item in TimeoutApplicationUISupport.playlistData:
