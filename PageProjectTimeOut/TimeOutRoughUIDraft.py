...
#    Feb 26, 2020 12:24:50 AM IST  platform: Windows NT
...
import TimeOutRoughUIDraft_support
import os.path
...
def vp_start_gui():
    ...
    root = tk.Tk()
    TimeOutRoughUIDraft_support.set_Tk_var()
    top = Toplevel1 (root)
    TimeOutRoughUIDraft_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    TimeOutRoughUIDraft_support.set_Tk_var()
    top = Toplevel1 (w)
    TimeOutRoughUIDraft_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.stopButton.configure(command=TimeOutRoughUIDraft_support.stop)
        ...
        self.startButton.place(relx=0.038, rely=0.215, height=64, width=70)
        ...
        self.startButton.configure(command=TimeOutRoughUIDraft_support.start)
        ...
        photo_location = os.path.join(prog_location,"../Users/91809/PycharmProjects/TimeoutApplication/icons/play2-button.png")
        global _img0
        _img0 = tk.PhotoImage(file=photo_location)
        self.startButton.configure(image=_img0)
        ...
        self.shuffleButton.configure(command=TimeOutRoughUIDraft_support.Shuffle)
        ...
        self.Spinbox1.configure(textvariable=TimeOutRoughUIDraft_support.spinbox)
        self.value_list = ['20',]
        ...
        self.Scrolledlistbox1.place(relx=0.552, rely=0.255, relheight=0.733
                , relwidth=0.446)
        ...
        self.DeleteButton.configure(command=TimeOutRoughUIDraft_support.deletePlaylistElements)
