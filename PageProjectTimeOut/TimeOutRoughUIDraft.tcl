...
#  Feb 26, 2020 11:37:44 PM IST  platform: Windows NT
set vTcl(timestamp) ""


set image_list { \
    play2_button_png "../Users/91809/PycharmProjects/TimeoutApplication/icons/play2-button.png" \
}
...
proc vTclWindow.top43 {base} {
    ...
    label $top.lab48 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {Welcome Username} 
    ...
    button $top.but50 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command stop \
    ...
    button $top.but52 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command start \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -image play2_button_png -pady 0 -text Start 
    vTcl:DefineAlias "$top.but52" "startButton" vTcl:WidgetProc "Toplevel1" 1
    button $top.but57 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command Shuffle \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Shuffle 
    ...
    button $top.but46 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -command deletePlaylistElements \
        -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Delete 
    ...
    place $top.but47 \
        -in $top -x 0 -relx 0.475 -y 0 -rely 0.121 -height 0 -relheight 0.032 \
        -anchor nw -bordermode ignore 
    place $top.lab48 \
        -in $top -x 0 -relx 0.015 -y 0 -rely 0.027 -width 0 -relwidth 0.133 \
        -height 0 -relheight 0.055 -anchor nw -bordermode ignore 
    place $top.but50 \
        -in $top -x 0 -relx 0.038 -y 0 -rely 0.336 -height 0 -relheight 0.032 \
        -anchor nw -bordermode ignore 
    place $top.but51 \
        -in $top -x 0 -relx -0.107 -y 0 -rely 0.537 -height 0 \
        -relheight 0.032 -anchor nw -bordermode ignore 
    place $top.but52 \
        -in $top -x 0 -relx 0.038 -y 0 -rely 0.215 -width 70 -relwidth 0 \
        -height 64 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but57 \
        -in $top -x 0 -relx 0.038 -y 0 -rely 0.443 -height 0 -relheight 0.032 \
        -anchor nw -bordermode ignore 
    place $top.scr68 \
    ...
    place $top.but46 \
        -in $top -x 0 -relx 0.56 -y 0 -rely 0.215 -width 97 -relwidth 0 \
